...
public class ArrayBlockingQueuePetStore {
    ...
    public static void main(String[] args) throws InterruptedException {
        Print.fo("jvmInstanceName: " + ManagementFactory.getRuntimeMXBean().getName());
...
//        Callable<IGoods> consumerAction2 = dateBuffer::fetch;
