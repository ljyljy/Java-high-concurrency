...
public class LockSupportDemo {
    ...
    public void testLockSupport2() {
        ...
        System.out.println("after 1st-LockSupport.unpark(t1)  - " + k++);
        //再唤醒一次没有使用 LockSupport.park()阻塞的线程
        LockSupport.unpark(t1);
        System.out.println("after 2nd-LockSupport.unpark(t1)  - " + k++);
        sleepSeconds(2);
        //中断线程一
        //第三唤醒使用 LockSupport.park()阻塞的线程
        LockSupport.unpark(t1);
        System.out.println("after 3rd-LockSupport.unpark(t1)  - " + k++);
    }
}
